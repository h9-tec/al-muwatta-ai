            ...
            {activeTab === 'chat' && (
              ...
              <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-800/70 border border-gray-700' : 'bg-white shadow-sm'}`}>
                ...
                <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                  ✨ Find solace in divine words: Receive authentic Quranic verses and Prophetic wisdom for comfort, peace, and spiritual healing.
                </p>
