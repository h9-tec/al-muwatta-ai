...
{text}"""
    ...
    # Stub classes when dspy is not available
    class FiqhQASignature:  # type: ignore
        pass

    class FiqhChainOfThought:  # type: ignore
        pass

    class DSPyMalikiFiqhRAG:  # type: ignore
        pass


def create_training_examples() -> list[Any]:
    """
